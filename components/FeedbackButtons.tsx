    ...
    <div className="flex flex-wrap gap-2 pt-3">
      {actions.map(({ label, action }) => (
        <button
          ...
          className="rounded-md border border-ink/10 bg-white/70 px-3 py-1.5 text-xs font-semibold text-ink/70 transition hover:border-fern/40 hover:text-fern disabled:cursor-not-allowed disabled:opacity-50"
        >
