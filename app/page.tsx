  ...
  return (
    <>
      ...
      <main className="mx-auto w-full max-w-6xl px-4 pb-16 sm:px-6">
        <section className="grid gap-6 py-10 lg:grid-cols-[1.4fr_0.6fr] lg:items-end">
          <div>
            <p className="text-sm font-bold uppercase tracking-[0.18em] text-gold">
              {briefing ? formatBriefingDate(briefing.briefing_date) : "Today"}
            </p>
            <h1 className="mt-3 max-w-3xl text-4xl font-black leading-tight text-ink sm:text-6xl">
          ...
          <div className="rounded-lg border border-ink/10 bg-white/75 p-5 shadow-soft">
            <div className="text-sm font-bold uppercase tracking-[0.16em] text-fern">
              Read Time
            </div>
        ...
        {!briefing ? (
          <div className="rounded-lg border border-ink/10 bg-white/80 p-6 shadow-soft">
            ...
            <p className="mt-2 text-sm leading-6 text-ink/65">
              ...
              <code className="mx-1 rounded bg-cloud px-1.5 py-0.5">POST /api/ingest/run</code>
